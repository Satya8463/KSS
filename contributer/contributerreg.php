...
<title>Contributer Registration</title>
</head>
<body bgcolor="lightgreen">
<br><br><br>
<h1 align="center" class="style1 style3">Contributer Registration</h1>

<form method="post" action="contributerreg.php" enctype="multipart/form-data">
...
if(isset($_POST['submit']))
{
	...
	$qry="insert into contributer_detail(username,password,cnfm_password,name,image,gender,age,dob,mobile,address) values('$username','$password','$cnfm_password','$name','$imagename','$egen','$age','$dob','$mob','$add')";
